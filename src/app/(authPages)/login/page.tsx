...
export default function LoginPage() {
    return (
        <div className='max-w-[370px] mx-auto py-16 w-full z-50 text-center'>
            ...
            <div className='text-center text-[#777777] flex gap-1 items-center justify-center text-[13px] mt-4'>
                Didn't have an account? <Link href={'/register'} className='font-medium'>Create Account</Link>
            </div>
        </div>
    )
}